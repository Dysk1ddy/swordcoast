...
class ProgressionMixin:
    ...
    def scale_level_resources(self, actor: Character) -> None:
        if actor.class_name in {"Bard", "Cleric", "Druid", "Paladin", "Sorcerer", "Warlock", "Wizard"}:
            actor.max_resources["spell_slots"] = actor.max_resources.get("spell_slots", 0) + 1
            actor.resources["spell_slots"] = actor.max_resources["spell_slots"]
