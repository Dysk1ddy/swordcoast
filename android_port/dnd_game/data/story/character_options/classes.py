...
CLASS_LEVEL_PROGRESSION = {
    ...
    "Druid": {2: {"features": [("Natural Recovery", "You regain 1 spell slot whenever the party takes a short rest.")], "feature_ids": ["natural_recovery"]}, 3: {"features": [("Wildfire Adept", "Your nature spells gain +1 damage and +1 healing.")], "feature_ids": ["wildfire_adept"], "equipment_bonuses": {"spell_damage": 1, "healing": 1}}, 4: {"features": [("Land's Embrace", "Gain +1 Defense and +1 Wisdom saving throws.")], "feature_ids": ["lands_embrace"], "equipment_bonuses": {"AC": 1, "WIS_save": 1}}},
